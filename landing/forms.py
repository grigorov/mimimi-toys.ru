...
class OrderForm(forms.ModelForm):
    ...
    mob = forms.CharField(label="Телефон",widget=forms.TextInput(attrs={'type':'tel','placeholder':'+79051234567'}),max_length=12,help_text="Укажите номер телефона. Наш менеджер с вами свяжиться.")
